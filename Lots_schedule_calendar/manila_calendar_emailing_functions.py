...
def send_new_work_type_notice_email(shop, type_of_work, name, date, desc, event_url_link, recipients_list):
    ...
    # body line 1
    email_1 = 2*br + ' ' + type_of_work + ' ' + name + " needs drawings in shop on " + date + "\n"
    # body line 2
    ...
    msg['Subject'] = 'Material Delivery Calendar ' + shop + ' New ' + type_of_work + ': ' + name
    # create the sender
...
def send_date_change_notice_email(shop, type_of_work, name, date, desc, event_url_link, recipients_list):
    ...
    print(name + ' now has shop drawing date on:\t' + date)
    # first email line
    email_preface = "\n<p>A change in material delivery date has been detected for a " + shop + " " + type_of_work + "\n"
    # body line 1
    email_1 = 2*br + type_of_work + ' ' + name + " now needs drawings in shop on " + date + "\n"
    # body line 2
    email_2 = 2*br + "<u>Event Description:</u><br></br>\n" + desc + "\n"
    # link to the calendar event
    email_3 = 2*br + "<u>Calendar Event Link:</u><br></br>\n" + event_url_link + "</p>\n"
    ...
    msg = MIMEMultipart("html") 
    # create the subject line
    msg['Subject'] = 'Material Delivery Calendar Date change for: ' + name
    # create the sender
...
def send_error_notice_email(shop, error_type, error_as_e):
    service = get_email_service()
    lots_log_errors_email_recipients = ['cwilson@crystalsteel.net','cwilson@crystalsteel.net',
                                        'awhitacre@crystalsteel.net','jturner@crystalsteel.net',
                                        'nmarinduque@crystalsteel.net','aadeguzman@crystalsteel.net',
                                        'wciocson@crystalsteel.net','eco@crystalsteel.net']
